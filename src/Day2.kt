...
fun main() {
    println(intProgram.joinToString())
...
fun stopProgram() {
    println(intProgram[0])
}

fun multipleValues(num1: Int, num2: Int, multiPos: Int) {
    intProgram[multiPos] = intProgram[num1] * intProgram[num2]
    println("Multiple: num1: $num1 - num2: $num2, multiPos: $multiPos, intProgram[multiPos]=${intProgram[multiPos]}")
    println(intProgram.joinToString())
}

fun addValues(num1: Int, num2: Int, sumPos: Int) {
    intProgram[sumPos] = intProgram[num1] + intProgram[num2]
    println("Add: num1: $num1 - num2: $num2, multiPos: $sumPos, intProgram[sumPos]=${intProgram[sumPos]}")
    println(intProgram.joinToString())
}

val demo = mutableListOf(1,9,10,3,2,3,11,0,99,30,40,50)


val intProgram = mutableListOf(
    1,
    12,
    2,
    3,
